        ...
        >
          ...
          >
            ...
            >
              ...
              <h1 className="uppercase tracking-[0.03em] text-[1.2rem] text-[aliceblue] h-[1.5rem] font-pp-right">
                {/* PATCH UP YOUR MARKETING */} MANAGE YOUR TIME EFFORTLESSLY
              </h1>
            </AnimatedSection>
            <AnimatedSection
              id="homedeader-image"
            ...
            >
              <h1 className="uppercase tracking-[0.03em] text-[1.2rem] text-[aliceblue] h-[1.5rem] font-pp-right">
                {/* GROW YOUR BUSINESS */} LIVE MORE EFFECTIVELY
              </h1>
              <img
                src={VenIcon}
                alt="Ven Icon"
          ...
          >
            ...
            >
              ...
              clinic owners. */}
              Set goals to pave your path, achieve dreams to fulfill your potential.
            </AnimatedSection>
            <AnimatedSection
