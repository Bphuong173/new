      ...
      <div id="people-slides" className="pl-[14px]">
        ...
        >
            ...
            <div className="flex flex-row w-full border-b border-[black] pb-4">
              ...
              >
                ...
                <img
                  src={ClientLogo2}
                  alt="Client Logo"
                  className="h-[30px] mt-[70px] ml-[70px] bg-[#C0CBDA]"
                />
              </div>
            </div>
          ...
          >
            ...
            >
              <h1 className="lg:text-[90.4px] text-[40px] flex lg:pt-[45px] pt-[60px] leading-[1.8px]">
                2
                <span className="lg:text-[61.9px] text-[40px] pt-[10px]">
                  ND
                </span>
              </h1>
              <p
                style={{ fontFamily: "Archivo, sans-serif" }}
                className="lg:text-[17px] text-[14px] lg:pt-[40px] pt-[20px] "
              >
            ...
            >
              <h1 className="lg:text-[90.4px] text-[60px] leading-[1.8px] flex lg:pt-[45px] pt-[60px]">
                2<span className="text-[61.9px] flex pt-[10px]">XD</span>
              </h1>
              <p
                style={{ fontFamily: "Archivo, sans-serif" }}
                className="lg:text-[17px] text-[14px] pt-[30px] "
              >
