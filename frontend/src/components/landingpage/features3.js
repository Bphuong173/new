...
export const Features3 = () => {
  return (
    <>
      <div className=" bg-[#f8f8f8] w-[326px]  rounded-md flex flex-col items-center">
        <div className="px-[38px] min-w-[238px] mt-[22px] max-w-[238px] justify-center flex items-center pt-[30px]  align-text-left border-b border-[#ffff] pb-[20px] ">
        ...
        <div className=" flex min-w-[238px] max-w-[238px] justify-center items-center h-[65px] pt-[10px]  align-text-left  pb-[20px] text-center ">
          <p
            ...
            className="text-[13px] min-w-[238px] max-w-[238px] justify-center"
          >
            Embedded knowledge base, slack channel. [1-3 day response time]
          </p>
        </div>
